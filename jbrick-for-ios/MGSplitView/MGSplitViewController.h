...
typedef enum _MGSplitViewDividerStyle {
    ...
    MGSplitViewDividerStyleShadow = 2 // Thin shadow, drawn with a black gradient
...
@interface MGSplitViewController : UIViewController <UIPopoverControllerDelegate> {
	...
	MGSplitDividerView *_dividerViewMD; // View that draws the divider between the master and detail views.
    MGSplitDividerView *_dividerViewDP; // View that draws the divider between the detail and property views.
...
@property (nonatomic, retain) IBOutlet UIViewController *propertyViewController; // convenience.
@property (nonatomic, retain) MGSplitDividerView *dividerViewMD; // the view which draws the divider/split between master and detail.
@property (nonatomic, retain) MGSplitDividerView *dividerViewDP; // the view which draws the divider/split between detail and master.
...
- (IBAction)showMaster:(id)sender; // Shows the master view if it's not currently shown
- (IBAction)hideMaster:(id)sender; // Hides the master view if it's not currently shown
